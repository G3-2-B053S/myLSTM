...
class LSTMModel(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, num_classes):
        ...
        self.lstm = mylstm.myLSTM(input_size, hidden_size, num_layers)
...
class SeqData(object):
    ...
    def read_data(self,data_path,y):
        ...
        for data in datas:
            ...
            curr_yArray[i]=y
            i=i+1
        fd=open(r"C:/Users/Administrator/PycharmProjects/pythonProject8/files/file.txt","a",encoding="utf-8")
